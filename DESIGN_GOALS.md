...
Thank you for your willingness to contribute to this project!
...
### Reviewing changes
Please make sure that the new issue is necessary to the project. Reviewing PRs, approving them, and then maintaining new features can take a lot of time and energy.
Please label the new issue as “discussion”, if it’s still in discussion, and - “implementation” when it’s ready to be written. Please add also “good first issue” and so on, to help contributors find issues that fit their skills.
...
[Here](https://github.com/OpenKnowledgeMaps/headstart-vue/docs/pull_request_template.md) you can find a template to view a PR:
